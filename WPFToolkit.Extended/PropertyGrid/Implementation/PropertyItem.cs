...
namespace Microsoft.Windows.Controls.PropertyGrid
{
    public class PropertyItem : Control
    {
        ...
        public static readonly DependencyProperty DispIdProperty = DependencyProperty.Register("DispId", typeof(int), typeof(PropertyItem), new UIPropertyMetadata(0));
        public int DispId
        {
            get { return (int)GetValue(DispIdProperty); }
            set { SetValue(DispIdProperty, value); }
        }
        #endregion //Category
        ...
        private static void OnIsReadOnlyChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (propertyItem != null)
            {
                ...
                {
                    propertyItem.IsEnabled = !(bool)e.NewValue;
                }
            }
        }
        ...
        public PropertyDescriptor PropertyDescriptor
        {
            ...
            private set
            {
                ...
                try
                {
                    DispId = ((DispIdAttribute)_propertyDescriptor.Attributes[typeof(DispIdAttribute)]).Value;
                }catch(Exception e) { }
        ...
        public PropertyItem(object instance, PropertyDescriptor property, PropertyGrid propertyGrid)
        {
            ...
            if(PropertyDescriptor is CustomizePropertyDescriptor)
            {
                var cp = PropertyDescriptor as CustomizePropertyDescriptor;
                cp.IsEnabledChanged += Cp_IsEnabledChanged;
                if (Editor != null)
                {
        ...
        private void Cp_IsEnabledChanged(object sender, EventArgs e)
        {
            var cp = PropertyDescriptor as CustomizePropertyDescriptor;
